...
<body>
    <header>
        ...
        <nav id="menulinks">
           <!-- different buttons to go to the differnt pages on grizzzlist -->
...
<main>
    <div id ="contactshow">
        ...
        <h1>Contact List</h1>
      <a href="showcontact.php">Order by firstname (A-Z)</a>,<a href="">Order by firstname (Z-A)</a>,<a href="showcontactlza.php">Order by lastname (Z-A)</a> 
        ...
        <table>
            ...
            $sql_list = "SELECT * FROM names ORDER BY last ASC";

...
<main>
    <div id ="contactshow">
        ...
        <h1>Contact List</h1>
       <a href="showcontact.php">Order by firstname (A-Z)</a>,<a href="showcontactl.php">Order by lastname (A-Z)</a>, <a href="showcontactlza.php">Order by lastname (Z-A)</a>  
        ...
        <table>
            ...
            $sql_list = "SELECT * FROM names ORDER BY first DESC";
